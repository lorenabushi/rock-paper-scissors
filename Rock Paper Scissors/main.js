...
function tie(userChoice, computerChoice) {
    result_p.innerHTML = `${convertToWord(userChoice)}(user) equals ${convertToWord(computerChoice)}(computer). Is a tie. `;
    userChoice_div.classList.add('black-glow');
    setTimeout( () => userChoice_div.classList.remove('black-glow'), 3000);
}
